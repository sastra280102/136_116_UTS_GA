package com.example.a116136utsga;
...
public class LaporLokasi extends AppCompatActivity implements FetchAddressTask.OnTaskCompleted {
    // Constants
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lapor_lokasi);
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(LaporLokasi.this);
        ...
        mLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (nama_lengkap.getText().toString().isEmpty()) {
                    Toast.makeText(LaporLokasi.this, "Masukkan Nama Anda", Toast.LENGTH_SHORT).show();
                } else if (no_whatsapp.getText().toString().isEmpty()) {
                    Toast.makeText(LaporLokasi.this, "Masukkan No. WhatsApp", Toast.LENGTH_SHORT).show();
                } else {
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                if (mTrackingLocation) {
                    new FetchAddressTask(LaporLokasi.this, LaporLokasi.this).execute(locationResult.getLastLocation());
                }
            }
        };
        return;
            ...
            mFusedLocationClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    if (!(location == null)) {
                        ...
                        Toast.makeText(LaporLokasi.this, "Aktifkan Lokasi", Toast.LENGTH_SHORT).show();
                    }
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(LaporLokasi.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void stopTrackingLocation() {
        if (mTrackingLocation) {
            ...
            lokasi.setText("Lokasi Saat Ini");
